# GitHub Rulesets — gh-platform-actions
...
```bash
# Run from a machine authenticated to the org that owns gh-platform-actions
gh api --method POST repos/{owner}/gh-platform-actions/rulesets \
